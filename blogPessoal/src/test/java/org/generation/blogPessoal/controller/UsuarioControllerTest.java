...
class UsuarioControladorTest {
	...
	@Disabled
	@Test
	void retornarListadeUsuarioRetornaStatus200() {
	...
	@Disabled
	@Test
	void atualizarSenhaUsuarioRetornaStatus201() {
		
		HttpEntity<Usuario> request = new HttpEntity<Usuario>(usuarioAlterar);
		
		ResponseEntity<Usuario> resposta = testRestTemplate.withBasicAuth("Paula Silva", "545454")
